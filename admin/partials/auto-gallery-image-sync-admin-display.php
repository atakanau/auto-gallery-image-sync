...
<a href="https://twitter.com/home?status=<?php echo str_replace(' ','%20',__('Auto Gallery And Image Sync', $this->plugin_name) ); ?>%20-%20<?php echo str_replace(' ','%20',__('Automatically sync posts (or WooCommerce Product) and media images as featured image and gallery.', $this->plugin_name) ); ?>%20%0A<?php echo str_replace(':','%3A',$aau_agisync_support_link); ?>" target="_blank"><i class="dashicons dashicons-twitter"></i> Twitter</a> 
<a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo str_replace(':','%3A',$aau_agisync_support_link); ?>&title=<?php echo str_replace(' ','%20',__('Auto Gallery And Image Sync', $this->plugin_name) ); ?>&summary=&source=" target="_blank"><i class="dashicons dashicons-linkedin"></i> LinkedIn</a>
			</td>
		</tr>
	</tbody>
</table>
	...
	<?php
		...
		<h2><?php esc_html_e( 'Auto Gallery And Image Sync',$this->plugin_name ); ?></h2>
